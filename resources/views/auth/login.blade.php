                ...
                <div class="flex flex-col break-words bg-white border border-2 rounded shadow-md">
                    ...
                    <form class="w-full p-6" method="POST" action="{{ route('login') }}">
                        ...
                        <div class="flex flex-wrap mb-6">
                            <label for="identity" class="block mb-2 text-sm font-bold text-gray-700">
                                {{ __('Username or E-Mail Address') }}:
                            </label>

                            <input id="identity" type="text" class="form-input w-full @error('identity') border-red-500 @enderror" name="identity" value="{{ old('identity') }}" required autofocus>
